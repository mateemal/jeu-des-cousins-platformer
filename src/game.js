...
const controlSchema = [
  ...
  ["jumpImpulse", "Impulsion du saut", 100, 7200, 10],
  ["gravity", "Gravité", 200, 20000, 25],
  ["maxHoldTime", "Appui maximum (s)", 0.02, 4, 0.01],
  ["holdGravityFactor", "Gravité pendant appui", 0.05, 4, 0.05],
  ["airRecoverySpeed", "Retour horizontal en saut", 0, 2400, 10],
